...
function ImageCarousel() {
  ...
  const productAds = {
    ...
    menShoes: "https://images.unsplash.com/photo-1612902376491-7a8a99b424e8?ixid=MXwxMjA3fDB8MHxzZWFyY2h8Njd8fHNob2VzfGVufDB8fDB8&ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=60"
}
    return (
        <div id="carouselExampleCaptions" className="carousel slide" data-ride="carousel">
          ...
          <div className="carousel-inner">
            <div className="carousel-item active">
              ...
              className="d-block w-100" alt="electronics"/>
            ...
            <div className="carousel-item">
              ...
              className="d-block w-100" alt="Women Clothing"/>
              <div className="carousel-caption d-none d-md-block">
                <h5>Women Fashion</h5>
            ...
            <div className="carousel-item">
              ...
              className="d-block w-100" alt="Men Clothing"/>
              <div className="carousel-caption d-none d-md-block">
                <h5>Men Fashion</h5>
            ...
            <div className="carousel-item">
              ...
              className="d-block w-100" alt="Kitchen Appliances"/>
              <div className="carousel-caption d-none d-md-block">
            ...
            <div className="carousel-item">
              ...
              className="d-block w-100" alt="Kid's Toys"/>
              <div className="carousel-caption d-none d-md-block">
                <h5>First slide label</h5>
                <p>Nulla vitae elit libero, a pharetra augue mollis interdum.</p>
              </div>
            ...
            <div className="carousel-item">
              ...
              className="d-block w-100" alt="Women Shoes"/>
              <div className="carousel-caption d-none d-md-block">
                <h5>Women Shoes</h5>
                <p>Nulla vitae elit libero, a pharetra augue mollis interdum.</p>
              </div>
            ...
            <div className="carousel-item">
              ...
              className="d-block w-100" alt="Men Shoes"/>
              <div className="carousel-caption d-none d-md-block">
                <h5>First slide label</h5>
                <p>Nulla vitae elit libero, a pharetra augue mollis interdum.</p>
              </div>
            ...
            <div className="carousel-item">
              <img src="https://images.pexels.com/photos/275033/pexels-photo-275033.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260" className="d-block w-100" alt="Gaming"/>
              <div className="carousel-caption d-none d-md-block">
                <h5>First slide label</h5>
                <p>Nulla vitae elit libero, a pharetra augue mollis interdum.</p>
              </div>
